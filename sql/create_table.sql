...
(
    ...
    enrollTerm   int                                null comment '0, 1,2,3,12,13,23,123,分别代表T1,T2,T3开学,0是未知',
...
INSERT INTO user_centre.course (code, title, category, toolTip, enrollTerm
  ...
  'COMP6713','6713 NLP','1','这是一门好课6713','123');

INSERT INTO user_centre.course (code, title, category, toolTip, enrollTerm
) VALUES (
 'COMP9417','9417 ML&DM','1','这是9417','1');

INSERT INTO user_centre.course (code, title, category, toolTip, enrollTerm
) VALUES (
 'COMP9101','9101 Algo. Des.&Ana.','0','这是9101','12');
